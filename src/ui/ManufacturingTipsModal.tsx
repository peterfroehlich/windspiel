    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" style={{ width: '720px' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
            ...
            <table className="pm-table" style={{ margin: '8px 0 12px' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Concert-grade tuned chimes (Music of the Spheres style)</td>
                </tr>
              </tbody>
            </table>
            <p>
          ...
          <Section title="2. Alloy Selection & Surface Finishing">
            <p>
              <b>EN AW-6060-T66 (AlMgSi0.5):</b> The gold standard alloy for wind chimes. Precipitation hardening (Mg₂Si precipitates)
              pins crystal dislocations, giving an outstanding quality factor (Q ≈ 3000–3500) and long singing sustain (6–10 s).
            </p>
            <p>
              <b>Eloxieren (Anodizing):</b> Highly recommended. It creates a 15–25 µm diamond-hard ceramic Al₂O₃ layer (400–500 HV).
              It preserves 100% of the acoustic sustain while preventing weather pitting, chalking, and striker indentations.
            </p>
